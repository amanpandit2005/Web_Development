...
// Read when Fullfilled/Rejected :-

// p1.then((response)=>{
//    console.log(response);   // Displayed in Byte format
// })

// const p2 = p1.then((response)=>{
//    return response.json();   // Display in Object format
// })

// p2.then((data)=>{
//     console.log(data);   // Displayed in Object format
// })
